...
def get_part11_checklist_data():
    return {"Controls for closed systems": {"11.10(a) Validation": True, "11.10(b) Accurate Copies": True, "11.10(e) Audit Trails": True, "11.10(f) Operational System Checks": False}, "Electronic Signatures": {"11.50 General Requirements": True, "11.200(a) Signature Components": False,}}

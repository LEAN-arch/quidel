...
with col2:
    st.subheader("Analysis of CAPA Sources")
    if not qms_df.empty:
    ...
    with st.expander("🔬 Director's Analysis & Preventive Action"):
        ...
        - **High count from "Post-Launch Complaint Trend":** This is a lagging indicator that our pre-market V&V may have missed a real-world use condition or interaction. **Action:** I will lead a review of our V&V strategy for the implicated product line to enhance our validation protocols.
        ...
        - **"Internal Audit Finding":** This points directly to a gap in our own procedures or training. **Action:** This requires immediate internal process review, potential SOP updates, and retraining for my team.
        """)

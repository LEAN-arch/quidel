# pages/4_Assay_V&V_Planning_&_Strategy.py
...
st.set_page_config(
    page_title="Assay V&V Planning | QuidelOrtho",
    layout="wide"
)
...
with st.expander("🌐 Manager's View: Laying the Foundation for Compliant Assay V&V", expanded=True):
    st.markdown("""
    Effective planning is the most critical phase of the V&V lifecycle. As the Manager, my primary role during this phase is to establish a robust and compliant V&V strategy that aligns with the product's intended use, regulatory pathway, and risk profile. This dashboard is my tool for overseeing the key planning deliverables that form the bedrock of a successful and auditable V&V campaign for our diagnostic assays.
...
with tab3:
    ...
    with st.expander("**Manager's Review of RTM**"):
        st.markdown("""
